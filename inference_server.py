...
async def startup_event():
    ...
    redis_client = redis.Redis(
        ...
        db=1,  # Different DB from job storage
...
async def generate_video(
    ...
    try:
        ...
        if request.seed:
            ...
            logger.info(f"🎲 Using isolated seed: {request.seed}")
        ...
        logger.info(f"⏱️ Video generated in {generation_time:.2f} seconds")
        ...
        cost_estimate = calculate_cost(generation_time, request.num_frames)
